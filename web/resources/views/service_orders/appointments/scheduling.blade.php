            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap p-3 border-bottom"
                        ...
                        {{-- Previous day --}}
                        @if ($prevDate)
                            <a href="{{ url('service/orders/appointments/scheduling') }}?tl_date={{ $prevDate }}"
                        ...
                        {{-- Next day --}}
                        @if ($nextDate)
                            <a href="{{ url('service/orders/appointments/scheduling') }}?tl_date={{ $nextDate }}"
                                class="btn btn-sm btn-outline-secondary">
                        ...
                        (function() {
                            ...
                            function makeAssessedBlock(row) {
                                ...
                                blk.style.cssText = [
                                    ...
                                    'left:' + pct(df) + ';',
                                    'width:' + ((dt - df) / TOTAL * 100).toFixed(4) + '%;',
                                    'background:#F4BBBB;color:#7A1010;',
