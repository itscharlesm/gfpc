...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Scheduled Appointment</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Scheduled</li>
                    ...
                    <div class="row">
                            ...
                            <table class="table table-bordered text-left align-middle">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $display->assigned_first_name }} {{ $display->assigned_last_name }}
                                        </td>

                                        <td style="font-weight: bold;">DATE ASSIGNED</td>
                                        <td colspan="3">
                                            @if ($display->svcas_date_assigned)
                                                {{ \Carbon\Carbon::parse($display->svcas_date_assigned)->format('m/d/Y | h:i A') }}
                                            @endif
                                        </td>
                                    </tr>
                        ...
                        <div class="d-flex justify-content-end flex-wrap mb-3 no-print">
                            <button type="button" class="btn btn-warning mr-2 mb-2" data-toggle="modal"
                                data-target="#changeTechnicianModal">
                                <span class="fa fa-user-edit"></span> Change Technician
                            </button>
                                ...
                                <div id="techTimelineWrap" style="display:none;">
                                    ...
                                    <div class="d-flex mb-2" style="gap:12px; font-size:11px; color:#666;">
                                        <span style="display:inline-flex;align-items:center;gap:4px;">
                                            <span
                                                style="width:12px;height:12px;border-radius:3px;background:#F4BBBB;border:0.5px solid #E07070;display:inline-block;"></span>
                    ...
                    if (dispFrom < dispTo) {
                        track.appendChild(
                            makeBlock(
                                ...
                                'This appointment',
                                '',
                                isAssigned ? '#F4BBBB' : '#C0DD97',
                                isAssigned ? '#7A1010' : '#27500A',
                                isAssigned ? '#E07070' : '#97C459'
                            )
                        );
                    }
                }
