...
class AppointmentController extends Controller
{
    ...
    public function scheduling_appointments(Request $request)
    {
        $search = $request->search ?? '';
        ...
        return view(
            'service_orders.appointments.scheduling',
            compact(
                'search',
                'view',
                'tlDate',
    ...
    public function assessed_appointments_view($svc_id)
    {
        ...
        return view('service_orders.appointments.view_assessed', compact('display', 'pestTypes', 'serviceAreas', 'termiteAreas', 'appointmentImages', 'technicians', 'approvedDate', 'approvedTimeFrom', 'approvedTimeTo', 'daySchedules', 'allTechs'));
    }
    ...
    public function scheduled_appointments_view($svc_id)
    {
        ...
        return view('service_orders.appointments.view_scheduled', compact(
            'display',
            'pestTypes',
            'serviceAreas',
            'termiteAreas',
